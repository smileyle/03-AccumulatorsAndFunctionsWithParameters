...
#                Clone, Move Center to, Outline Color
#
#          -- Write the names of three INSTANCE VARIABLEs that Circle
#             objects have:
#                Radius, Height, Center Point
#
#     f. What does a RoseWindow RENDER method do?
#            Render Draws the objects attached to the window
#
#     g. When is a RoseWindow close_on_mouse_click method call
#        necessary?  Why?
#            It is necessary when looking specifically at the graphic such as reading it,
#                   gathering data, or when mulitple windows will appear.
#
