...
def run_test_digits_in_cube():
    ...
    print('     actual:', answer)
    expect2 = 18
    answer2 = digits_in_cube(9)
    print('Test 2 expected:', expect2)
    print('     actual:', answer2)
    expect3 = 17
    answer3 = digits_in_cube(14)
